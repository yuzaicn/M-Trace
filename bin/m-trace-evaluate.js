...
if (
  ...
  console.log(
    'Usage: m-trace-evaluate --input dataset.json --max-distance VALUE --min-margin VALUE --min-relative-margin VALUE [--expected-open-set-models 2] [--seed 73013]',
  );
...
const report = evaluateDataset(dataset, {
  ...
  expectedOpenSetModels: Number(option('--expected-open-set-models', '2')),
